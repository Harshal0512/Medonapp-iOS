...
class ReportCellWithIconAndDescription: UIView {
    ...
    static func instantiate(viewBackgroundColor: UIColor, icon: UIImage, iconBackgroundColor: UIColor, title: String, numberOfFiles: Int) -> ReportCellWithIconAndDescription {
